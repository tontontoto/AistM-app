    ...
    return (
        <div className="w-full">
            ...
            <div className="mb-4 sm:mb-6">
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-1 sm:mb-2">ユーザー管理</h1>
                <p className="text-sm sm:text-base text-gray-600">登録されているユーザーを検索・確認できます</p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-4 sm:p-6 mb-4 sm:mb-6">
                <div className="flex items-center gap-2 mb-3 sm:mb-4">
                    ...
                    <h2 className="text-lg sm:text-xl font-semibold text-gray-800">検索フィルター</h2>
                </div>
                ...
                <>
                    ...
                    <div className="mb-4 flex items-center justify-between">
                        <p className="text-sm sm:text-base text-gray-600">
                            {filteredUsers.length === users.length ? (
                                <span>全 <span className="font-semibold text-gray-800">{users.length}</span> 件のユーザー</span>
                            ) : (
                                <span>
                                    <span className="font-semibold text-gray-800">{filteredUsers.length}</span> 件が見つかりました
                                    <span className="text-gray-500 ml-2">（全 {users.length} 件中）</span>
                                </span>
                            )}
                        </p>
                    </div>
                    ...
                    {filteredUsers.length === 0 ? (
                        <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
                            ...
                            <p className="text-gray-500 text-lg mb-2">該当するユーザーが見つかりませんでした</p>
                                ...
                                >
                                    ...
                                    <div className="space-y-2 mb-4">
                                        ...
                                        <div className="flex items-center gap-2 text-sm text-gray-600">
                                            ...
                                            <span>ログイン回数: {user.login_count || 0}回</span>
                                        </div>
                                    </div>
